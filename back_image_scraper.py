...
class BackImageScraper:
    ...
    def scrape_back_image(self, game: str, output_dir: str = "game/back") -> bool:
    ...
    def scrape_all_back_images(self, output_dir: str = "game/back") -> Dict[str, bool]:
    ...
    def create_back_image_index(self, output_dir: str = "game/back") -> str:
...
@click.option('--output-dir', '-o', default='game/back',
